...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css_variables_and_animation_experiment.css">
    <link href="https://fonts.googleapis.com/css2?family=Architects+Daughter&display=swap" rel="stylesheet">
	<script async="" src="file://maps.google.com/maps/api/js?key=AIzaSyAFeB0kVA6ouyJ_gEvFbMaefLy3cBCyRwo&amp;sensor=false&amp;libraries=geometry,places&amp;v=3.7&amp;_=1595949015331"></script>
	<link rel="icon" href="assets/images/favicons/favicon.ico" type="image/x-icon">
	<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Thiết kế hiện đại">
    ...
    <!-- PAGE TITLE -->
    <title>Designer Flat</title>
    <!-- BOOTSTRAP CSS -->
    <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.min.css">
    <!-- ALL GOOGLE FONTS -->
    <link href="../../../css.css?family=Poppins:300,400,500,600,700|Montserrat:300,400,500,600,700,800,900&subset=latin-ext" rel="stylesheet">
    <!-- FONT AWESOME CSS -->
        ...
        <div class="container">
            <div class="row">
				...
				<div class="col-md-12" style="padding-top: 45px;">
					...
					<a href="#"><div class="col-xs-6 col-sm-4 col-md-3 fa-hover"  style="color: #fff;"><i class="fa fa-twitter"></i>twitter</div></a>
	...
	<footer class="page-foot section-inset-4 bg-primary">
		...
		<div class="container">
            <div class="row text-left clearleft-custom">
              ...
              <div class="col-xs-12 col-sm-6 col-lg-3">
                <h4>newsletter</h4>
                <p class="text-gray">Enter your email address to receive all news, updates on new arrivals, special offers and other discount information.</p>
                <!-- RD Mailform-->
